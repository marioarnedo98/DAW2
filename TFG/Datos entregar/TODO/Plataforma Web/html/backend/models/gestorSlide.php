...
class GestorSlideModel{
	...
	public function subirImagenSlideModel($datos,$usuario, $tabla){ 
	...
	public function actualizarSlideModel($datos, $tabla){
		...
		$stmt = Conexion::conectar()->prepare("UPDATE $tabla SET titulo = :titulo, descripcion = :descripcion, id_user= :iduser WHERE id = :id");	
