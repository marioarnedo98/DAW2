...
======================================-->
	...
	<div class="col-lg-2 col-md-2 col-sm-3 col-xs-12" id="col1">
		...
		<div id="logo" class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
			...
			<img src="views/images/LogoTransparente.png" class="img-responsive" alt="Image">
		...
		<a href="../" target="_blank"><button type="button" class="btn btn-primary">Ver sitio</button></a>
